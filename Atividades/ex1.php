...
<head>
    ...
    <title>Atravessar/Dirigir?</title>
</head>
<body>
    <form action="ex1-final.php" method="get">
        ...
        if($position == "Pedestre")
        {
            ...
            <select name="slcCondition1" id="slcCondition1" required>
            ...
            <select name="slcCondition2" id="slcCondition2" required>
                <option value="" disabled selected>Selecione...</option>
        ...
        else 
        {
            ...
            <select name="slcCondition3" id="slcCondition3" required>
                <option value="" disabled selected>Selecione...</option>
                <option value="semaforookay">Sim</option>
                <option value="semaforoerrado">Não</option>
            </select>
